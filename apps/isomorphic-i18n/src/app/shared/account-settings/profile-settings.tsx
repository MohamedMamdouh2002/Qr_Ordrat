...
export function ProfileHeader({
  ...
  return (
    <div
      className={cn(
        " relative z-0 pt-28 before:absolute before:start-0 before:top-0 before:h-40 before:w-full before:bg-gradient-to-r before:from-[#F8E1AF] before:to-[#db9b6e] @3xl:pt-[190px] @3xl:before:h-[calc(100%-120px)] dark:before:from-[#bca981] dark:before:to-[#cbb4b4] md:-mx-5 lg:-mx-8 xl:-mx-6 3xl:-mx-[33px] 4xl:-mx-10",
        layout === LAYOUT_OPTIONS.BERYLLIUM && expandedLeft
          ? "before:start-5 3xl:before:start-[25px]"
          : "xl:before:w-[calc(100%_+_10px)]"
      )}
    >
      <div className="w-[95%] md:w-[85%] relative z-10 mx-auto flex max-w-screen-2xl flex-wrap items-end justify-start gap-6 border-b border-dashed border-muted pb-10">
