...
function Footer({lang}:{lang:string}) {
	...
	return (
    <div className="mt-10  bg-orange-500/20">
      <div className="w-[90%] mx-auto sm:grid grid-cols-5 py-4">

      </div>
      <div className="w-[90%] mx-auto sm:grid grid-cols-6 py-4">
        ...
        <div className="">
			...
			<div className="border-t border-t-black/25 py-2 flex items-center justify-center text-center gap-2">
				<p className="text-sm font-medium text-black/copyRights">
